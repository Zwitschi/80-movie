"""Compatibility shim for bot config repository modules.

Import from the split modules directly:
- bot_config_repo_common  – BotManagedRuntimeConfig dataclass
- bot_config_repo_memory  – InMemoryBotConfigRepository
- bot_config_repo_postgres – PostgresBotConfigRepository + builder
"""
